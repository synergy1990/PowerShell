...
$TestOutput = New-ADTestData -Count 15 | Select-Object UserID, GivenName, SurName, SamAccountName, EMailAddress, telephoneNumber, Fax, MobilePhone, Title, Department, StreetAddress, PostalCode, City, HomePage, HomePhones
